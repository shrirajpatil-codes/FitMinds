/**
 * FitMirror AI Adaptive AI Insights & Strategy Health Mock Data
 */
export const adaptiveInsights = [
  {
    id: 'ins_1',
    title: 'FITMIRROR AI INSIGHT',
    summary: 'Your 20-minute sessions have been easier to complete during evening study windows.',
    explanation: 'FitMirror AI observed that workouts scheduled after 6:00 PM with durations under 25 minutes have a 92% completion rate, whereas morning workouts had frequent postponements.',
    type: 'recommendation',
    date: 'Today',
  },
  {
    ...
    summary: 'Exam week workload detected. FitMirror AI automatically prioritized stress-relief mobility.',
...
export const strategyHealthData = {
  ...
  detail: 'FitMirror AI is balancing exam week academic stress with lightweight 20-minute movement windows.',
  signals: [
  ...
  upcomingAdaptations: [
    'FitMirror AI will keep session durations at 15–20 minutes through Friday to accommodate midterm project deadlines.',
