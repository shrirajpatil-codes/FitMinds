    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="space-y-3">
        ...
        {currentPlan.exercises.map((ex, idx) => (
          <Card key={ex.id || idx} variant="default" className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-slate-700 transition-colors">
